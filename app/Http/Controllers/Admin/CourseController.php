...
class CourseController extends Controller
{
    ...
    {
        $course->load(['instructor', 'enrollments.student', 'assignments.courseGroups']);
        ...
        return view('admin.courses.show', compact('course', 'activeStudents', 'completedStudents', 'materials'));
    }
