...
class InformationCardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.information-cards.index', compact('cards'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.information-cards.create', compact('roles', 'users'));
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'target_roles.*' => ['in:admin,guru,dosen,siswa,mahasiswa'],
        ...
        return redirect()->route('admin.information-cards.index')
    ...
    public function edit(InformationCard $informationCard)
    {
        ...
        return view('admin.information-cards.edit', compact('informationCard', 'roles', 'users'));
    }
