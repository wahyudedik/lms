    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="{{ route(auth()->user()->getRolePrefix() . '.question-bank.edit', $questionBank) }}"
            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg">
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <form
                            action="{{ route(auth()->user()->getRolePrefix() . '.question-bank.duplicate', $questionBank) }}"
                            ...
                            <button type="submit"
                                ...
                                <i class="fas fa-copy"></i>{{ __('Duplikasi') }}
                            </button>
                        </form>

                        <form
                            action="{{ route(auth()->user()->getRolePrefix() . '.question-bank.destroy', $questionBank) }}"
