    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-database mr-2"></i>{{ __('Add Question to Bank') }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md rounded-lg">
                <div class="p-6">
                    <form action="{{ route(auth()->user()->getRolePrefix() . '.question-bank.store') }}" method="POST"
                        ...
                        <div class="mb-8 pb-8 border-b border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                ...
                                <div class="flex items-end">
                                    ...
                                    <label
                                        class="flex items-center p-3 bg-indigo-50 rounded-lg border border-indigo-200">
                                        <input type="checkbox" name="is_shared" value="1"
                                            {{ old('is_shared', false) ? 'checked' : '' }}
                                            class="rounded border-gray-300 text-indigo-600 shadow-sm">
                                        <span
                                            class="ml-2 text-sm font-semibold text-gray-700">{{ __('Share ke guru lain') }}</span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="explanation" id="explanation" rows="3"
                                    class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-150">{{ old('explanation') }}</textarea>
