<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route(auth()->user()->getRolePrefix() . '.exams.create') }}"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route(auth()->user()->getRolePrefix() . '.exams.index') }}"
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <div class="flex gap-3">
                                                    ...
                                                    <form
                                                        action="{{ route(auth()->user()->getRolePrefix() . '.exams.destroy', $exam) }}"
