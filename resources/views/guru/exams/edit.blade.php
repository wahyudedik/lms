    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-edit mr-2"></i>{{ __('Edit Exam: :title', ['title' => $exam->title]) }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md rounded-lg">
                <div class="p-6">
                    <form action="{{ route(auth()->user()->getRolePrefix() . '.exams.update', $exam) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-8 pb-8 border-b border-gray-200">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-150"
                                    placeholder="{{ __('Enter description...') }}">{{ old('description', $exam->description) }}</textarea>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="instructions" id="instructions" rows="3" placeholder="Instruksi khusus untuk peserta ujian..."
                                    class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-150">{{ old('instructions', $exam->instructions) }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div id="tab_switch_settings"
                                    ...
                                    <label for="max_tab_switches" class="block text-sm font-semibold text-gray-700 mb-2">
                                        <i class="fas fa-exclamation-triangle text-gray-400 mr-1"></i>Maksimal Perpindahan Tab
                                    </label>
                                ...
                                <div id="window_blur_settings"
                                    ...
                                    <label for="max_window_blurs" class="block text-sm font-semibold text-gray-700 mb-2">
                                        <i class="fas fa-window-restore text-gray-400 mr-1"></i>Maksimal Keluar Aplikasi
                                    </label>
                                ...
                                <div id="inactivity_settings"
                                    ...
                                    <label for="max_inactivity_minutes" class="block text-sm font-semibold text-gray-700 mb-2">
                                        <i class="fas fa-user-clock text-gray-400 mr-1"></i>Batas Waktu Inaktivitas (menit)
                                    </label>
