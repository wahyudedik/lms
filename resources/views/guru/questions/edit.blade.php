        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route(auth()->user()->getRolePrefix() . '.', [$exam, $question]) }}" method="POST"
                            ...
                            <div id="similarity-fields"
                                ...
                                <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                                    ...
                                    <textarea name="essay_model_answer" id="essay_model_answer" rows="4"
                                        ...
                                        placeholder="Contoh: Fotosintesis adalah proses tumbuhan membuat makanan menggunakan cahaya matahari...">{{ old('essay_model_answer', $question->essay_model_answer) }}</textarea>
                                </div>
