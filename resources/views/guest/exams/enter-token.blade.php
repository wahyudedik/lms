...
<head>
    ...
    <title>Akses Ujian - {{ config('app.name', 'Laravel LMS') }}</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white shadow-2xl overflow-hidden sm:rounded-2xl">
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Akses Ujian via Token</h2>
                <p class="text-gray-600 mt-2">Masukkan token ujian yang Anda terima</p>
            </div>
            ...
            <form method="POST" action="{{ route('guest.exams.verify-token') }}">
                ...
                <div class="mb-6">
                    ...
                    <input id="token" type="text" name="token" value="{{ old('token') }}" maxlength="8"
                        required autofocus placeholder="Contoh: ABC123XY"
                    ...
                    <p class="mt-2 text-xs text-gray-500 text-center">
                        <i class="fas fa-info-circle"></i> Token terdiri dari 8 karakter (huruf/angka)
                    </p>
                </div>
                ...
                <div class="flex items-center justify-center mt-6">
                    <button type="submit"
                        ...
                        <i class="fas fa-sign-in-alt mr-2"></i> Akses Ujian
                    </button>
                </div>
            </form>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 text-center">
                <p class="text-sm text-gray-600">
                    <i class="fas fa-question-circle text-indigo-600"></i> Tidak punya token?
                </p>
                <p class="text-xs text-gray-500 mt-1">
                    Hubungi guru/admin untuk mendapatkan token ujian
                </p>
                <div class="mt-4">
        ...
        <div class="w-full sm:max-w-md mt-6 text-white text-center">
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <p class="text-xs">Akses Cepat</p>
                </div>
                <div>
                    <i class="fas fa-shield-alt text-2xl mb-2"></i>
                    <p class="text-xs">Aman & Terpercaya</p>
                </div>
                <div>
                    <i class="fas fa-mobile-alt text-2xl mb-2"></i>
                    <p class="text-xs">Mobile Friendly</p>
                </div>
            </div>
        </div>
    </div>
