<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-900 mb-2">{{ __('Forgot Password?') }}</h2>
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative mt-1">
                ...
                <x-text-input id="email" class="block w-full pl-10" type="email" name="email" :value="old('email')" required autofocus placeholder="{{ __('you@example.com') }}" />
            </div>
