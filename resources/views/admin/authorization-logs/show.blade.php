    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-shield-alt text-red-600 mr-2"></i>Authorization Log Details
            </h2>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Log #{{ $authorizationLog->id }}</h3>
                </div>
                ...
                <div class="px-6 py-4 space-y-6">
                        ...
                        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">
                                    ...
                                    @else
                                        <span class="text-gray-400">Guest / Unauthenticated</span>
                                    @endif
                                </dd>
                            </div>
                            <div>
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-gray-700 mb-3">Resource Information</h4>
                        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                    ...
                    <div>
                        ...
                        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Ability</dt>
                    ...
                    @if($authorizationLog->reason)
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 mb-3">Reason</h4>
                    ...
                    @if($authorizationLog->metadata)
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 mb-3">Additional Metadata</h4>
