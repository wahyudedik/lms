                    ...
                    <form action="{{ route('admin.question-bank.update', $questionBank) }}" method="POST"
                        ...
                        <div class="mb-6">
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="mcq_single" {{ old('type') == 'mcq_single' ? 'selected' : '' }}>{{ __('MCQ Single') }}</option>
                                <option value="mcq_multiple" {{ old('type') == 'mcq_multiple' ? 'selected' : '' }}>{{ __('MCQ Multiple') }}</option>
                                <option value="matching" {{ old('type') == 'matching' ? 'selected' : '' }}>{{ __('Matching') }}</option>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="file" name="question_image" id="question_image" accept="image/*"
                                class="w-full">
                            <p class="text-sm text-gray-500 mt-1">{{ __('Max 2MB (JPG, PNG, GIF)') }}</p>
                        </div>
                        ...
                        <div class="mb-6">
                            <label for="teacher_notes" class="block text-sm font-medium text-gray-700 mb-2">
                                Teacher Notes (Optional - Private)
                            </label>
                            <textarea name="teacher_notes" id="teacher_notes" rows="3"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('teacher_notes') }}</textarea>
