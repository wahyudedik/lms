    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                Import Details #{{ $importHistory->id }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-4">Import Overview</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold">
                                {{ $importHistory->started_at ? $importHistory->started_at->format('Y-m-d H:i:s') : 'Not started' }}
                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Completed At</p>
                            <p class="text-sm font-semibold">
                                {{ $importHistory->completed_at ? $importHistory->completed_at->format('Y-m-d H:i:s') : 'Not completed' }}
                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Processing Time</p>
                            <p class="text-sm font-semibold">
                                {{ $importHistory->processing_time ? $importHistory->processing_time . ' seconds' : '-' }}
                            </p>
                        </div>
                        <div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold mb-4 text-red-600">
                            ...
                            Errors ({{ count($importHistory->errors) }})
                        </h3>
