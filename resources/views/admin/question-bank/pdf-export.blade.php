...
<head>
    <meta charset="utf-8">
    <title>{{ __('Question Bank Export') }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>📚 {{ __('Question Bank Export') }}</h1>
        <div class="meta">
            {{ __('Exported on:') }} {{ $exported_at }} | {{ __('Total Questions:') }} {{ $total }}
        </div>
    </div>
    ...
    @foreach ($questions as $index => $question)
        <div class="question">
            <div class="question-header">
                <span class="question-number">{{ __('Question #:num', ['num' => $index + 1]) }}</span>
                <div class="badges">
    ...
    <div class="footer">
        {{ __('Generated by LMS Question Bank System') }}
    </div>
</body>
