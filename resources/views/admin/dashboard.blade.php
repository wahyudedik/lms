    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
                ...
                <p class="text-blue-100">Anda login sebagai <span
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-orange-100 text-sm">Average Score</p>
                            <p class="text-3xl font-bold mt-2">{{ number_format($stats['avg_exam_score'], 1) }}%</p>
                            <p class="text-orange-100 text-xs mt-1">
                                <i class="fas fa-chart-line mr-1"></i>System performance
                            </p>
                        </div>
                        <div class="bg-white bg-opacity-20 rounded-full p-3">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <a href="{{ route('admin.courses.create') }}"
                        ...
                        <span class="text-gray-700 font-medium">Create Course</span>
                    </a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h4 class="text-lg font-semibold text-gray-900"><i
                                class="fas fa-user-plus text-blue-500 mr-2"></i>Recent Users</h4>
                    ...
                    @empty
                        <p class="text-center text-gray-500 py-4">No recent users</p>
                    @endforelse
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h4 class="text-lg font-semibold text-gray-900"><i
                                class="fas fa-clipboard-list text-purple-500 mr-2"></i>Active Exams</h4>
                    ...
                    @forelse($activeExams as $exam)
                        <div class="flex items-center p-3 bg-gray-50 rounded-lg mb-2 hover:bg-gray-100 transition">
                            ...
                            <span class="text-xs text-gray-500">{{ $exam->questions_count }} questions</span>
                        </div>
                    @empty
                        <p class="text-center text-gray-500 py-4">No active exams</p>
                    @endforelse
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h4 class="text-lg font-semibold text-gray-900"><i
                                class="fas fa-book-open text-green-500 mr-2"></i>Recent Courses</h4>
                    ...
                    @empty
                        <p class="text-center text-gray-500 py-4">No recent courses</p>
                    @endforelse
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h4 class="text-lg font-semibold text-gray-900"><i
                                class="fas fa-chart-bar text-orange-500 mr-2"></i>Recent Exam Attempts</h4>
                    </div>
                    ...
                    @empty
                        <p class="text-center text-gray-500 py-4">No recent attempts</p>
                    @endforelse
                </div>
            </div>
