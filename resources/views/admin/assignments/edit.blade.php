        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md rounded-lg">
                <div class="p-6" x-data="{
                    ...
                    <form action="{{ route('admin.courses.assignments.update', [$course, $assignment]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-8 pb-8 border-b border-gray-200">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="description" id="description" rows="4"
                                    class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-150"
                                    placeholder="Masukkan deskripsi tugas...">{{ old('description', $assignment->description) }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                                ...
                                <select name="material_id" id="material_id"
                                    ...
                                    @foreach ($materials as $material)
                                        <option value="{{ $material->id }}"
                                            {{ old('material_id', $assignment->material_id) == $material->id ? 'selected' : '' }}>
                                            {{ $material->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-8 pb-8 border-b border-gray-200">
                            ...
                            <div x-show="latePolicy === 'penalty'" x-transition class="mt-4">
                                ...
                                <input type="number" name="penalty_percentage" id="penalty_percentage"
                                    value="{{ old('penalty_percentage', $assignment->penalty_percentage) }}"
                                    min="1" max="100"
