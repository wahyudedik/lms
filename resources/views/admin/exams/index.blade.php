    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-clipboard-list mr-2"></i>{{ __('Exam Management') }}
            </h2>
                    ...
                    <form method="GET" action="{{ route('admin.exams.index') }}"
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-search text-gray-400 mr-1"></i>{{ __('Cari') }}
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-book text-gray-400 mr-1"></i>{{ __('Kursus') }}
                            </label>
