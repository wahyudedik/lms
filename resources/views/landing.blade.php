...
<style>{!! $school->theme->generateCSS() !!}</style>
@endif
</head>
<body>
...
<li class="menu_social_item menu_mm"><a href="{{ $school->social_instagram ?? '#' }}"><i class="fab fa-instagram"></i></a></li>
<li class="menu_social_item menu_mm"><a href="{{ $school->social_facebook ?? '#' }}"><i class="fab fa-facebook-f"></i></a></li>
<li class="menu_social_item menu_mm"><a href="{{ $school->social_twitter ?? '#' }}"><i class="fab fa-twitter"></i></a></li>
</ul>
</div>
...
<div class="hero_slide_background" style="background-image:url({{ $school->hero_image_url }})"></div>
<div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
<div class="hero_slide_content text-center">
<h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">{!! $school->hero_title ?? 'Get your <span>Education</span> today!' !!}</h1>
</div>
</div>
</div>
...
<img src="{{ asset('course/images/earth-globe.svg') }}" class="svg" alt="">
...
<div class="card">
<img class="card-img-top" src="{{ $course->cover_image ? asset('storage/'.$course->cover_image) : asset('course/images/course_1.jpg') }}" alt="{{ $course->title }}">
<div class="card-body text-center">
<div class="card-title"><a href="{{ route('login') }}">{{ $course->title }}</a></div>
...
<div class="course_author_name">{{ $course->instructor->name ?? 'Instructor' }}, <span>Author</span></div>
...
<div class="search_background" style="background-image:url({{ asset('course/images/search_background.jpg') }});"></div>
...
<div class="testimonials_background prlx" style="background-image:url({{ asset('course/images/testimonials_background.jpg') }})"></div>
</div>
<div class="container">
...
<img src="{{ asset('course/images/testimonials_user.jpg') }}" alt="">
</div>
...
<img src="{{ asset('course/images/event_1.jpg') }}" alt="https://unsplash.com/@theunsteady5">
</div>
</div>
...
<div class="col-lg-4 order-lg-3 order-1">
<div class="event_image">
<img src="{{ asset('course/images/event_2.jpg') }}" alt="https://unsplash.com/@claybanks1989">
</div>
</div>
...
<div class="col-lg-4 order-lg-3 order-1">
<div class="event_image">
<img src="{{ asset('course/images/event_3.jpg') }}" alt="https://unsplash.com/@juanmramosjr">
</div>
</div>
...
<p class="footer_about_text">{{ $school->about_content ? Str::limit($school->about_content, 150) : 'In aliquam, augue a gravida rutrum, ante nisl fermentum nulla, vitae tempor nisl ligula vel nunc. Proin quis mi malesuada, finibus tortor fermentum, tempor lacus.' }}</p>
...
<span>
Copyright &copy;{{ date('Y') }} All rights reserved <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Noteds Technology</a>
</span>
</div>
...
<li class="menu_social_item"><a href="{{ $school->social_instagram ?? '#' }}"><i class="fab fa-instagram"></i></a></li>
<li class="menu_social_item"><a href="{{ $school->social_facebook ?? '#' }}"><i class="fab fa-facebook-f"></i></a></li>
<li class="menu_social_item"><a href="{{ $school->social_twitter ?? '#' }}"><i class="fab fa-twitter"></i></a></li>
</ul>
</div>
</div>
